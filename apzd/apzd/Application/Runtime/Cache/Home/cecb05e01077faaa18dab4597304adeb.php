    ...
    <div class=" clearfix" style="width:100%">
        <div id="add_brand" class="clearfix" style="width:100%">
            <div class="left_add" style="width:100%">
                <div class="title_name" style="width:100%">招聘添加</div>
                <ul class="add_conent">
                    <li class=" clearfix">
                        <label class="label_name">职位名称：</label>
                        <input name="job_name" type="text" class="add_text" placeholder="请输入职位名称"/>
                    </li>
                    <li class=" clearfix">
                        <div class="col-xs-1">
                        ...
                        <div class="col-xs-11">
                            <p>&emsp;
                                <input name="job_duty[]" type="text" class="add_text" placeholder="请输入一条工作职责"
                                       style="width:350px;"/>&emsp;
                                <a href="javascript:void(0);" onclick="addRow1(this);" class="btn btn-warning"><i
                                        class="icon-plus"></i> 再来一条</a>
                                <br> <br>
                            </p>
                        </div>
                    </li>
                    <li class=" clearfix">
                        ...
                        <div class="col-xs-11" id="zz">
                            <p>&emsp;
                                <input name="job_require[]" type="text" class="add_text" placeholder="请输入一条任职要求"
                                       style="width:350px;"/>&emsp;
                                <a href="javascript:void(0);" onclick="addRow1(this);" class="btn btn-warning"><i
                                        class="icon-plus"></i> 再来一条</a>
                                <br> <br>
                    ...
                    <li class=" clearfix"><label class="label_name">状态：</label>
                        <label><input name="job_show_status" type="radio" class="ace" checked="checked" value="启用"><span
                                class="lbl">启用</span></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <label><input type="radio" class="ace" name="job_show_status" value="停用"><span
        ...
        <div class="button_brand"><input name="" type="button" id="submit" class="btn btn-info" value="添加"/><input
                type="reset" value="重置" class="btn btn-default"/></div>
    </div>
</form>
</body>
</html>
...
<script type="text/javascript">
    ...
    $('#submit').click(function () {
        ...
        $.ajax({
            type: 'post',
            url: "/apzd/apzd/index.php/Home/Employ/add",
            data: form,
            ...
            success: function (response) {
                ...
                if (response.status) {
                    ...
                    layer.msg(response.result, {icon: 1, time: 1000}, function () {
                        location.href = "/apzd/apzd/index.php/Home/Employ/lst";
