...
<div class="margin clearfix">
 <div class="Guestbook_style">
     ...
     <div class="border clearfix">
       <span class="l_f">
        <a href="/apzd/apzd/index.php/Home/Company/wish_add" title="添加公司愿景" class="btn btn-warning Order_form"><i class="icon-plus"></i>添加公司愿景</a>

       </span>
         <span class="r_f">共：个</span>
     </div>
    ...
    <?php foreach($wishData as $k => $v): ?>
		...
		<tr>
          <td><?php echo $v['id'];?></td>
          <td style="text-align: left;font-size:20px;color:#666666;font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;"><span style="font-weight: bold"><?php echo $v['wish_title'];?> ：</span><?php echo $v['wish_desc'];?></td>
          <td><?php echo $v['wish_time'];?></td>
          <td class="td-manage">
              <a href="/apzd/apzd/index.php/Home/Company/wish_save/id/<?php echo $v['id'];?>" title="编辑" id="save" class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>
...
<script type="text/javascript">
    ...
    function member_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            $.ajax({
                url : '/apzd/apzd/index.php/Home/Company/wish_delete/id/'+id,
