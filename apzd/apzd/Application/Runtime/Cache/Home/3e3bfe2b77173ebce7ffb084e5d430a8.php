...
<div class=" clearfix" style="width:100%">
    <div id="add_brand" class="clearfix" style="width:100%">
        ...
        <div class="title_name" style="width:100%">动态添加</div>
        <ul class="add_conent">

            <li class=" clearfix"><label class="label_name">动态标题：</label> <input name="active_name" type="text" class="add_text" style="width:300px;"/></li>
                ...
                <div class="demo l_f">
                   <div class="imgbox">
                       <div class="resizebox" style="width:<?php echo C('ACTIVE_IMAGE_WIDTH');?>px;height:<?php echo C('ACTIVE_IMAGE_HEIGHT');?>px;">
                           <img src="/apzd/Public/images/image.png" width="100%" height="90%" />
                       </div>
            ...
            <li class=" clearfix"><label class="label_name">状态：</label>
                <label><input name="active_show_status" type="radio" class="ace" checked="checked" value="启用"><span class="lbl">启用</span></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <label><input type="radio" class="ace" name="active_show_status" value="停用"><span class="lbl">停用</span></label>
            </li>
...
$('#submit').click(function(){
    ...
    $.ajax({
        type : 'post',
        url : "/apzd/index.php/Home/Active/add",
        data : form,
