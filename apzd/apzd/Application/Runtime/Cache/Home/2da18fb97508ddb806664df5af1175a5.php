  ...
  <div id="brand_style">
    <div class="search_style">
      ...
      <ul class="search_content clearfix">
          <form action="/apzd/apzd/index.php/Home/Advice/lst">
       <li><label class="l_f">服务项目名称</label><input name="search" type="text"  class="text_add" placeholder="输入服务项目名称" value="<?php echo $_GET[search]?>" style=" width:250px"/></li>
     ...
     <div class="border clearfix">
       <span class="l_f">
        <a href="/apzd/apzd/index.php/Home/Advice/add" title="添加服务项目" class="btn btn-warning Order_form"><i class="icon-plus"></i>添加服务项目</a>

        <a href="/apzd/apzd/index.php/Home/Advice/lst" class="btn btn-success">全部服务项目</a>
       </span>
       <span class="r_f">共：<?php echo count($adData);?>个服务项目</span>
     </div>
      ...
      <div class="table_menu_list" style="width:100%">
          <table class="table table-striped table-bordered table-hover" id="sample-table">
              ...
              <tr>
                  <th width="80px">ID</th>
                  <th width="50px">排序</th>
                  <th width="120px">服务项目名称</th>
                  <th width="120px">服务项目内容</th>
              ...
              <?php foreach($adData as $k => $v): ?>
                  ...
                  <td width="50px"><input type="text"  onblur="sort(this,'<?php echo $v[id];?>')" sort="<?php echo $v['advice_sort'];?>" class="input-text text-c" value="<?php echo $v['advice_sort']?>" style="width:60px"></td>
                  <td><?php echo $v['advice_title']; ?></td>
                  <td><?php echo $v['advice_content']; ?></td>
                  <td><?php echo $v['advice_time'];?></td>
                  <td class="td-status">
                  <?php if($v['advice_show_status'] == '启用'):?>
                  ...
                  <td class="td-manage">
                      ...
                      <?php endif;?>
                      <a title="服务项目修改" href="/apzd/apzd/index.php/Home/Advice/save/id/<?php echo $v['id'];?>"  class="btn btn-xs btn-info save" ><i class="icon-edit bigger-120"></i></a>
...
function member_stop(obj,id){
    ...
    layer.confirm('确认要停用吗？',function(index){
        $.ajax({
            type : 'post',
            url : '/apzd/apzd/index.php/Home/Advice/setShowStatus',
            data : {
                id : id,
                status : 0,
            },
...
function member_start(obj,id){
    ...
    if(session == ""){
        top.location.href="<?php echo U('Login/login');?>";
    }
...
function sort(obj,id){
    ...
    $.ajax({
        type : 'post',
        url : '/apzd/apzd/index.php/Home/Advice/sort',
        data : {
            num:num,id:id
        },
        dataType : 'json',
...
function member_del(obj,id){
    layer.confirm('确认要删除吗？',function(index){
        $.ajax({
            url : '/apzd/apzd/index.php/Home/Advice/delete/id/'+id,
            dataType : 'json',
            success : function(response){
