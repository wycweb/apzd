...
<div class=" clearfix" style="width:100%">
    <div id="add_brand" class="clearfix" style="width:100%">
        ...
        <div class="title_name" style="width:100%">客户添加</div>
        <ul class="add_conent">
            <input type="hidden" name="id" value="<?php echo $data['id'];?>">
            <input type="hidden" name="old_img" value="<?php echo $data['ab_image'];?>">
            <li class=" clearfix"><label class="label_name">客户名称：</label> <input name="customer_name" type="text" class="add_text"/></li>
            ...
            <li class=" clearfix"><label class="label_name">状态：</label>
                <label><input name="customer_show_status" type="radio" class="ace" checked="checked" value="启用"><span class="lbl">启用</span></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <label><input type="radio" class="ace" name="customer_show_status" value="停用"><span class="lbl">停用</span></label>
            </li>
...
$('#submit').click(function(){
    ...
    $.ajax({
        type : 'post',
        url : "/apzd/index.php/Home/Customer/add",
        data : form,
        ...
        success : function (response){
            ...
            if(response.status){
                $('#submit').val('添加');
                layer.msg(response.result,{icon:1,time:1000},function (){location.href="/apzd/index.php/Home/Customer/lst";$('#submit').attr('disabled',false);});
            }else{
